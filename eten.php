        ...
        <table class="table table-striped" id="overzicht">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th scope="col">Valt onder</th>

                </tr>
            </thead>
            <tbody> 
                <!-- klanten are rows and klant is a single row  -->
                <?php foreach ($eten as $yum): ?>
                    <tr>
                        <td><?php echo $yum["code"]; ?></td>
                        <td><?php echo $yum["naam"];?></td>
                        <td><?php echo $yum["prijs"];?></td>
                        <td><?php echo $yum["gerechtscategorienID_ph"];?></td>
                        <td class="noExl">
